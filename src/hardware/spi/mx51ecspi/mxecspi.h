...
#define MX51_CSPI_BURST_MAX		0x20			/* we only support 32 bytes MAX burst bytes for now */
...
#define CSPI_CONTROLREG_POST_DVDR	0x0f00
#define CSPI_CONTROLREG_PRE_DVDR	0xf000
#define CSPI_CONTROLREG_DRCTL_MASK	0x30000
#define CSPI_CONTROLREG_DRCTL_POS	16
#define CSPI_CONTROLREG_DRCTL_EDGE      1
#define CSPI_CONTROLREG_DRCTL_LEVEL     2
#define CSPI_CONTROLREG_CSEL_MASK	0xC0000
...
#define CSPI_CONFIGREG_SSCTL		0x0f00
#define CSPI_CONFIGREG_SSCTL_POS	8
#define CSPI_CONFIGREG_POL		0xf0
#define CSPI_CONFIGREG_POL_MASK		4
#define CSPI_CONFIGREG_PHA		0xf
#define CSPI_CONFIGREG_PHA_MASK		0
#define CSPI_CONFIGREG_SSPOL		0xf000
#define CSPI_CONFIGREG_SSPOL_MASK	12
#define CSPI_CONFIGREG_DATACTL		0xf0000
#define CSPI_CONFIGREG_CLKCTL		0xf00000
...
#define CSPI_PERIODREG_CSD_CTRL		0x3f0000

// TESTREG BIT Definitions
#define CSPI_TESTREG_LOOPBACK		(1 << 31)
#define CSPI_TESTREG_RXCNT		8
#define CSPI_TESTREG_RXCNT_MASK		0x7f00
#define CSPI_TESTREG_TXCNT_MASK		0x007F
...
typedef struct {
	uintptr_t vbase;				/* the virtual base address of gpiobase used as chipselect */
...
#define MSK_GPIO		(~(3 << 7))	/* get only the gpio number used for chip selection */
