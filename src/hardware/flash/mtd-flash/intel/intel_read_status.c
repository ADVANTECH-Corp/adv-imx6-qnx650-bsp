...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto650/freescale-mx6q-sabreARD/latest/src/hardware/flash/mtd-flash/intel/intel_read_status.c $ $Rev: 658671 $" );
