...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto650/freescale-mx6q-sabreARD/latest/src/hardware/flash/mtd-flash/amd/aCFI_v2suspend.c $ $Rev: 658671 $" );
