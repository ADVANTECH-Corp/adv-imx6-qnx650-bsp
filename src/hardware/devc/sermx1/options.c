...
/*
#ifdef __USAGE
%C - Serial driver for MC9328MX1/MX21/MX31/MX51 UARTs
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto650/freescale-mx6q-sabrelite/latest/src/hardware/devc/sermx1/options.c $ $Rev: 633202 $" );
