...
#define MCU_2_SSIAPP_ADDR	6258
#define SSIAPP_2_MCU_ADDR	6608
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto650/freescale-mx6q-sabrelite/latest/src/lib/dma/sdma/imx6x/script.c $ $Rev: 633202 $" )
