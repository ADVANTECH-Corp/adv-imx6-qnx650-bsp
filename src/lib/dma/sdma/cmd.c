 ...
 * The command channel priority should be set lower than realtime streams
...
#define SDMA_CMD_COMPLETE_PULSE_PRIO        21
...
int sdmacmd_cmdch_create() {
    ...
    cmd_complete_event.sigev_priority = SDMA_CMD_COMPLETE_PULSE_PRIO;
...
void sdmacmd_ctx_config(sdma_chan_t * chan_ptr) {
    ...
    default:    
        ...
        /* For SDMA VERSION2, the event is more than 32, 
         * so we need to use register 0 to pass context
         */
